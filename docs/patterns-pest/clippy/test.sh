...
uitest "docs/patterns-pest/clippy/mut-from-ref.rpl"                                                                "tests/ui/clippy/mut_from_ref.rs"
...
uitest "docs/patterns-pest/clippy/zst-offset.rpl"                                                                  "tests/ui/clippy/zst_offset.rs"
