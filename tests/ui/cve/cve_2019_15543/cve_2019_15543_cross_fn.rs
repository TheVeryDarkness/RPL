...
impl<T> SliceDeque<T> {
    ...
    fn wrap_if_underflow(&mut self, new_head: &mut isize, cap: usize, tail: isize) -> bool {
        if *new_head as usize > cap {
    ...
    fn wrap_if_overflow(&mut self, new_head: &mut isize, cap: usize, tail: isize) -> bool {
    ...
    pub unsafe fn move_head_unchecked(&mut self, x: isize) {
        ...
        self.wrap_if_underflow(&mut new_head, self.tail_, tail)
            || self.wrap_if_overflow(&mut new_head, self.tail_, tail);
